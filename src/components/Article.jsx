            ...
            <section className="min-w-fit" >
                <div className="flex flex-row mt-2">
                    <div className="w-auto h-auto rounded-full border-2 border-pink-500 min min-w-fit">
                        <img className='w-12 h-12 object-cover rounded-full shadow cursor-pointer' alt='User avatar' src={article?.image} />
                    </div>
                    <div class="flex flex-col mb-2 ml-4 mt-1">
                        <div className='text-gray-600 text-sm font-semibold line-clamp-1'>{article?.author}</div>
